...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/tetujin/com.awareframework.ios.sensor.device'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tetujin' => 'tetujin@ht.sfc.keio.ac.jp' }
  s.source           = { :git => 'https://github.com/tetujin/com.awareframework.ios.sensor.device.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'com.awareframework.ios.sensor.device' => ['com.awareframework.ios.sensor.device/Assets/*.png']
  # }
